This project consist of an user hospital registration page in which  admmin can create an ID and add personal details,address details,medical history,departments etc.
